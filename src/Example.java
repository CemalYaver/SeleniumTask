	...
	public static void main(String[] args) {
		...
		String mainPageControl = driver.findElement(By.xpath("//link[@rel='canonical']")).getText();
		 ...
		 if(mainPageControl.contains("https://www.amazon.com/")) {
		    	System.out.println("Burasý Anasayfa");
		    }
		    else {
		    	System.out.println("Burasý Anasayfa Deðil!");
		    }
	    ...
	    if(searchVerification) {
	        System.out.println("samsung için arama yapýldý");
	    }
	    else {
	        System.out.println("samsung için arama yapýlmadý");
	    }
	    	
	    String pageControl = driver.findElement(By.xpath("//meta[@name='keywords']")).getText();
	    
	    if(pageControl.contains("Page 2")) {
	    	System.out.println("Burasý 2.sayfa");
	    }
	    else {
	    	System.out.println("Burasý 2.sayfa deðil!");
	    }
